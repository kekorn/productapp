# ProductApp - Docker & Minikube környezetben
...
## Használat Minikube-bal (Kubernetes)
...
# 1. Környezeti változók beállítása a minikube-hoz
& minikube -p minikube docker-env | Invoke-Expression

# 2. Build és Docker konténer létrehozása
docker-compose build

# 3. Alkalmazás futtatása a k8s/ mappával
kubectl apply -f k8s/
```
...
docker tag mongo $DOCKER_USER/productapp-mongo:latest
```
...
docker push $DOCKER_USER/productapp-mongo:latest
```
